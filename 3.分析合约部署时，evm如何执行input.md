...
![6_DUP](./image/6_DUP.png)

##### 007 ISZERO :

这一步执行后,stack：

![7_ISZERO](./image/7_ISZERO.png)

**008 PUSH2  0010**

![8_PUSH2](./image/8_PUSH2.png)
...
​	![18_PUSH2](./image/18_PUSH2.png)

##### 021 DUP1

执行完后的 stack:

​	![21_DUP1](./image/21_DUP1.png)
