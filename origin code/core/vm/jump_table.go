...
type operation struct {
	...
	returns bool /* 返回 */// determines whether the operations sets the return data content
}
...
//newHomesteadInstructionSet返回可在Homestead阶段执行的边界和Homestead指令。
...
//newFrontierInstructionSet返回可在前沿阶段执行的前沿指令。
